...
(function () {
  ...
  const EAMX_BUMERAN_VERSION = "2026-05-26-audit-pass";
  console.log(`[EmpleoAutomatico] bumeran.js loaded — version ${EAMX_BUMERAN_VERSION} — ${location.href}`);
  try { window.__eamx_loaded = { source: "bumeran", version: EAMX_BUMERAN_VERSION, at: new Date().toISOString() }; } catch (_) {}
