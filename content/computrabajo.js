...
(function () {
  ...
  // Computrabajo exposes the posting id as `?id=XYZ` in the query string on
  // most detail pages; fall back to any 5+ digit number in the URL, then to a
  // hash of the full URL (same as OCC).
