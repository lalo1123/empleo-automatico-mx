...
// apply a penalty instead of a bonus. The buckets are intentionally
// coarse — too many buckets and noise dominates.
const DOMAIN_BUCKETS = {
  sales: [
    "sales", "ventas", "comercial", "business", "negocios", "client", "cliente",
    "account", "cuenta", "growth", "revenue", "ingresos", "channel", "canal",
    "cierre", "prospect", "lead", "demand", "demanda", "kam", "key"
  ],
  marketing: [
    "marketing", "mercadotecnia", "brand", "marca", "campaign", "campaña",
    "content", "contenido", "seo", "sem", "performance", "social", "media",
    "medios", "publicidad", "advertising", "creative", "creativo", "comms",
    "comunicacion", "comunicaciones", "branding", "communications"
  ],
  tech: [
    "developer", "engineer", "ingeniero", "software", "frontend", "backend",
    "fullstack", "devops", "cloud", "data", "ml", "ai", "qa", "tester",
    "tester", "tech", "tecnologia", "systems", "sistemas", "infra",
    "infrastructure", "infraestructura", "ux", "ui", "api", "javascript",
    "python", "java", "react", "node", "azure", "aws", "kubernetes",
    "ti", "it", "programador"
  ],
  ops: [
    "operations", "operaciones", "logistics", "logistica", "supply", "cadena",
    "warehouse", "almacen", "procurement", "compras", "planning", "planeacion",
    "scheduling", "process", "proceso"
  ],
  finance: [
    "finance", "finanzas", "accounting", "contabilidad", "tax", "fiscal",
    "treasury", "tesoreria", "audit", "auditoria", "controller", "controlling"
  ],
  hr: [
    "hr", "rrhh", "human", "humanos", "talent", "talento", "recruiting",
    "recruitment", "reclutamiento", "people", "compensation", "compensaciones"
  ],
  design: [
    "design", "diseno", "designer", "disenador", "graphic", "grafico",
    "creative", "art", "artistic"
  ],
  product: [
    "product", "producto", "owner", "scrum", "agile", "roadmap", "po"
  ],
  legal: [
    "legal", "abogado", "compliance", "contract", "contrato"
  ],
  healthcare: [
    "medical", "medico", "doctor", "nurse", "enfermero", "salud", "health",
    "pharma", "farmaceutica"
  ]
};
