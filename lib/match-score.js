...
const DOMAIN_BUCKETS = {
  ...
  marketing: [
    ...
    "comunicaciones", "comunicador", "comunicadora", "digital", "growth",
    "demand", "generation", "performance", "ppc", "cpa", "ctr", "roas",
    "email", "newsletter", "crm", "hubspot", "mailchimp", "marketo",
    "salesforce", "google", "facebook", "meta", "instagram", "tiktok",
    "youtube", "linkedin", "influencer", "influencers", "community",
    "manager", "cm", "copywriter", "copywriting", "redactor", "redaccion",
    "storytelling", "endomarketing", "trade", "atl", "btl", "ooh",
    "merchandising", "shopper", "consumer", "consumidor", "research",
    "investigacion", "insights", "ux", "messaging", "posicionamiento",
  ...
  tech: [
    ...
    "sistemas", "infra", "infrastructure", "infraestructura", "ux",
    "ui", "uxui", "interface", "interfaz", "api", "apis", "rest",
    ...
    "cybersecurity", "security", "seguridad", "informatica", "informatico",
    "informatica", "blockchain", "web3", "nft", "iot", "embedded",
    "android", "ios", "mobile", "movil", "sap", "salesforce", "abap",
    "oracle", "sql", "nosql", "mongodb", "postgres", "mysql", "redis",
    "kafka", "spark", "hadoop", "etl", "elt", "dba", "lider",
  ...
  ops: [
    ...
    "planning", "scheduling", "scheduler", "process", "procesos",
    "proceso", "transporte", "transportes", "transportista", "transports",
    "shipping", "envios", "envio", "inventory", "inventario", "inventarios",
    "stock", "stocks", "wms", "tms", "erp", "sap", "manufacturing",
    "manufactura", "production", "produccion", "fabrica", "factory",
    "plant", "planta", "plantas", "lean", "kaizen", "kanban", "six",
    "sigma", "kpi", "kpis", "sla", "ehs", "calidad", "quality",
    "control", "logistico", "logistica", "delivery", "deliveries",
    "entregas", "entrega", "fulfillment", "outbound", "inbound",
    "trafico", "traffic", "ruta", "rutas", "monitoreo", "operations"
  ],
  ...
  finance: [
    ...
    "ifrs", "nif", "ifrs", "gaap", "csox", "sox", "compliance",
    "regulatory", "regulatorio", "regulatoria", "cfo", "ceo", "cobranza",
  ...
  hr: [
    ...
    "employer", "branding", "atraccion", "retencion", "retention",
    "talento", "succession", "sucesion", "sst", "labor", "laboral",
  ...
  legal: [
    ...
    "intelectual", "patent", "patente", "patentes", "trademark", "marca",
    "marcas", "lawyer", "lawyers", "counsel", "general", "in", "house",
    "corporate", "corporativo", "corporativa", "asesor", "juridico",
    "juridica", "judicial", "ministerio", "publico", "fiscal", "notario"
  ],
  // Salud / medicina
  healthcare: [
    ...
    "investigacion", "clinical", "research"
  ],
  // Educación
  education: [
  ...
  hospitality: [
    ...
    "cocinera", "cocinero", "cocina", "kitchen", "mesero", "mesera",
  ...
  retail: [
    ...
    "supervisor", "supervisora", "gerente", "gerencia", "tienda",
  ...
  manufacturing: [
    ...
    "plantas", "planta", "ensamble", "ensambladora", "maquila",
    "maquiladora", "calidad", "quality", "qa", "qc", "quality", "control",
    "iso", "lean", "manufacturing", "kaizen", "six", "sigma", "tpm",
    ...
    "ehs", "process", "operacion", "operario", "operaria", "tecnico",
    "tecnica", "tecnicos", "mantenimiento", "maintenance"
  ],
  // Customer support / atención al cliente
  customer: [
    "customer", "cliente", "clientes", "service", "servicio", "servicios",
    ...
    "ticket", "tickets", "zendesk", "freshdesk", "intercom", "salesforce",
    "service", "csat", "nps", "ces", "telefonica", "telefonico",
    "mesa", "ayuda", "first", "level", "second", "level", "supervisor",
    "lider", "team", "leader"
  ],
  ...
  construction: [
    ...
    "estructural", "ingeniero", "ingeniera", "ingenieros", "ingenieria",
    "constructora", "constructoras", "obra", "residente", "residentes",
    "supervisor", "supervisora", "supervision", "topografo", "topografa",
    "topografia", "geotecnia", "geotecnico", "concreto", "acero",
    "albañileria", "albañil", "carpintero", "carpinteria", "plomero",
    "plomeria", "electrico", "electrica", "instalaciones", "hvac",
    "construction", "remodelacion", "remodelaciones", "demolicion",
    "demoliciones", "infraestructura", "infrastructure"
  ],
  // Inmobiliaria
  realestate: [
    "real", "estate", "realtor", "realtors", "inmobiliaria",
    "inmobiliarias", "inmobiliario", "broker", "brokers", "agente",
    "agentes", "valuacion", "valuador", "valuadora", "appraisal",
    "leasing", "renta", "rentas", "venta", "ventas", "patrimonio",
    "patrimonial", "property", "properties", "propiedad", "propiedades",
    "asesor", "asesoramiento", "tasacion", "tasador"
  ],
  // Gobierno / sector público
  government: [
    "gobierno", "government", "publico", "public", "publica", "federal",
    "estatal", "municipal", "municipio", "estado", "secretaria",
    "secretarias", "secretario", "secretaria", "subsecretario", "director",
    "general", "subdirector", "subdirectora", "director", "regulatorio",
    "regulatoria", "ministerio", "ministerios", "ayuntamiento", "alcalde",
    "alcaldesa", "diputado", "diputada", "senador", "senadora", "congreso",
    "politicas", "politico", "politica", "publica"
  ],
  // Atención administrativa / oficina
  admin: [
    "admin", "administrativo", "administrativa", "administracion",
    "secretaria", "secretarias", "secretario", "secretarias",
    "asistente", "asistentes", "assistant", "executive", "ejecutivo",
    "ejecutiva", "ejecutivos", "recepcion", "recepcionista",
    "receptionist", "office", "oficina", "oficinas", "manager",
    "ofimatica", "auxiliar", "auxiliares", "agenda", "viajes",
    "travel", "calendar", "agenda"
  ],
  ...
  media: [
    ...
    "editorial", "publicacion", "publicaciones", "publishing", "publisher",
    "noticias", "news", "noticiero", "noticiera", "broadcast",
    "broadcasting", "tv", "television", "radio", "podcast", "videografia",
    "fotografia", "fotografo", "fotografa", "camarografo", "camarografa"
  ],
  // Inseguridad / seguridad física
  security: [
  ...
  sustainability: [
    ...
    "environmental", "ambiental", "ambiente", "medio", "verde", "green",
    "carbon", "huella", "footprint", "renewable", "renovable", "solar",
    "eolica", "wind", "csr", "responsabilidad", "social", "corporativa",
    "rsc", "filantropia", "philanthropy", "circular", "economia",
    "ods", "sdg", "sustainability"
  ]
};
...
export function computeListingMatchScore(profile, jobLite, preferences = null) {
  ...
  // Critical: the overlap must include at least one NON-suffix token
  // (a "discipline anchor" like sales/marketing/data/ops). Otherwise a
  // sales person with "Business Developer" in their CV would match an
  // "IT Solution Developer" title just on the word "developer", which
  // is wildly misleading. Generic suffix matches alone count as 0.
  ...
  for (const t of titleTokens) {
    if (roleTokens.has(t)) {
      overlapAll.push(t);
      if (!ROLE_GENERIC_SUFFIXES.has(t)) overlapAnchors.push(t);
    }
  }
  // Score the overlap by anchor tokens (the discipline words). Suffixes
  // contribute +2 each as a tiebreaker but never alone.
  ...
  // the title. Same rule: generic suffixes don't count alone.
  const summaryTokens = new Set(tokenize(normalize(profile?.summary || ""), 200));
  const summaryAnchors = [];
  for (const t of titleTokens) {
    if (summaryTokens.has(t) && !roleTokens.has(t) && !ROLE_GENERIC_SUFFIXES.has(t)) {
  ...
  const profileDomain = dominantDomain(classifyDomain(profileBag));
  const titleDomain = dominantDomain(classifyDomain(titleTokens));
  let domainDelta = 0;
