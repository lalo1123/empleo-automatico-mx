...
//
// TODO: support Google Sign-In via chrome.identity.launchWebAuthFlow when
// needed. Today the extension uses email/password only; Google Sign-In on
// the landing already issues the same backend session JWT, so users can
// sign in there and paste the token into the extension as a workaround
// until this lands.
